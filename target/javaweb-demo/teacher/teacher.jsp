...
<div class="left">
    ...
    <div class="menux">
        ...
        <ul>
            <li>
                <a href="javascript:void(0);" url="/teacher/teacherInformation.jsp" title="个人信息">
                    <i class="fa fa-caret-right"></i>
                    个人信息
                </a>
                <a href="javascript:void(0);" url="/teacher/teacherUpdate.jsp" title="修改个人信息">
                    <i class="fa fa-caret-right"></i>
                    修改个人信息
                </a>
                <a href="javascript:void(0);" url="/teacher/teacherlist.jsp" title="查询个人所带课程安排">
                    <i class="fa fa-caret-right"></i>
                    查询个人所带课程安排
                </a>
                <a href="javascript:void(0);" url="/ClassroomSearchServlet" title="查询教室情况">
                    <i class="fa fa-caret-right"></i>
                    查询教室情况
                </a>
                <a href="javascript:void(0);" url="/teacher/teacherApply.jsp" title="申请调课">
                    <i class="fa fa-caret-right"></i>
                    申请调课
                </a>
            </li>
...
<div class="main">
    ...
    <iframe src="/teacher/teacherInformation.jsp" width="100%" height="90%" frameborder="0"></iframe>
</div>
</body>
</html>
