...
<body>
<form action="/ClassroomOperationServlet?method=delete" method="post">
    <div class="condition">
    ...
    <table class="tablelist">
        ...
        <c:if test="${not empty applicationScope.classRoomList}">
            <c:forEach items="${applicationScope.classRoomList}" var="classroom">
                <tr>
